...
documents_train, target_train, raw_cats = load_multiclass_data()
...
X_train, X_test, y_train, y_test = train_test_split(texts_padded, target_train.values,
                                                    test_size=0.1, random_state=42, stratify=raw_cats)

dir_name = 'data/word_vectors/pubmed_stratify_no_wiki_'
